        ...
        Card(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  const Padding(
                      ...
                      child: Icon(Icons.push_pin,
                          color: Colors.red) //priorityMapping[task.priority]),
                      ),
                  const Text(
                    'task name',
                    style: TextStyle(
              ...
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    IconButton(onPressed: (){}, icon: Icon(Icons.add_circle, color: Colors.lightBlue), iconSize: 30)
              ...
              const Padding(
                padding: EdgeInsets.symmetric(horizontal: 40.0, vertical: 10.0),
                child: Text('Progress ${75}%', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500))
              ),
              Container(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    minHeight: 8,
                    valueColor: AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 82, 221, 70)),
                    value: 0.75,
                  ),
                ),
              ),
